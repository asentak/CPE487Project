## vga_top.xdc
## variation from starter code: incorporated switches and an led to our program (see bottom of the file)
...
## ---------------Added in following things to starter code for new inputs and outputs --------------
